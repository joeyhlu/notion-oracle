...
const SYSTEM = ["calendar_list_calendars", "calendar_list_events", "calendar_find_events", "calendar_create_event", "calendar_update_event", "calendar_delete_event", "calendar_set_default_calendar", "calendar_move_event"] as const;
